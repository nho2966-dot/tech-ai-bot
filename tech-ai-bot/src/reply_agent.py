...
import tweepy
import random
import google.generativeai as genai  # ✅ التصحيح 1
import cohere
...
# Configure APIs
genai.configure(api_key=os.getenv('GEMINI_KEY'))  # ✅ التصحيح 2
...
def generate_tech_content():
    ...
    try:
        ...
        response = requests.post(  # ✅ التصحيح 3
        ...
        co = cohere.Client(api_key=os.getenv('COHERE_API_KEY'))  # ✅ التصحيح 4
        ...
        model = genai.GenerativeModel('gemini-2.5-flash')  # ✅ التصحيح 5
        ...
        gemini_response = model.generate_content(gemini_prompt)  # ✅ التصحيح 6
